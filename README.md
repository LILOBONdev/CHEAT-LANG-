...
Подсветить всех игроков-врагов вне вашей команде: `/script instance highlight EnemyTeam` - не нужно указывать цвет подсветки, игроки будут подсвечиваться цветом своей команды. Можно также найти игрока с определенным интревалом здоровья: `/script instance highlight players.Health 100 <` - Мы подсвечиваем игроков у которых здоровья меньше 100%, можно также задать знак неравенства.
