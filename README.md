![C.H.BANNER](https://cdn.discordapp.com/attachments/1271329696377733186/1272716441669468220/Banner.png?ex=66cdc94d&is=66cc77cd&hm=cdae8fa60eed488600f798fdc68cad52fd9f14c3cc16901f94f1603e331f2a0c&)
# UPDATE V.1.11 - CHEAT LANG (ЧИТ ТУТ)
...
* Реализована система кастомного чита UI (BETA) - Страница 4 в документации ;
...
**синтаксис**
Разрабатывается новый синтаксис (BETA). Обещаю, кодить станет в 100 раз легче, никаких задержек со стороны нас, тот синтаксис к которому мы шли, код прошлого синтаксиса был очень большой и был понятен только некоторым, теперь каждый сможет разобрать в Cheat Lang. (Сегодня завезу уже новый синтаксис), попращайтесь со старым.
